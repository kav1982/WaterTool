...
Shader "MTE/LWRP/7 Textures"
{
    Properties
    {
		...
		_Smoothness4("Smoothness 5", Range( 0 , 1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 WeightedBlend785( half4 Weight , half4 WeightExtra , float4 Layer1 , float4 Layer2 , float4 Layer3 , float4 Layer4 , float4 Layer5 , float4 Layer6 , float4 Layer7 )
			{
				return Layer1 * Weight.r + Layer2 * Weight.g + Layer3 * Weight.b + Layer4 * Weight.a + Layer5 * WeightExtra.r + Layer6 * WeightExtra.g + Layer7 * WeightExtra.b;
			}
			
			float4 WeightedBlend789( half4 Weight , half4 WeightExtra , float4 Layer1 , float4 Layer2 , float4 Layer3 , float4 Layer4 , float4 Layer5 , float4 Layer6 , float4 Layer7 )
			{
				return Layer1 * Weight.r + Layer2 * Weight.g + Layer3 * Weight.b + Layer4 * Weight.a + Layer5 * WeightExtra.r + Layer6 * WeightExtra.g + Layer7 * WeightExtra.b;
			}
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 localWeightedBlend785 = WeightedBlend785( Weight85 , WeightExtra85 , Layer185 , Layer285 , Layer385 , Layer485 , Layer585 , Layer685 , Layer785 );
				...
				float4 Layer789 = float4( float3(0.5,0.5,1) , 0.0 );
				float4 localWeightedBlend789 = WeightedBlend789( Weight89 , WeightExtra89 , Layer189 , Layer289 , Layer389 , Layer489 , Layer589 , Layer689 , Layer789 );
				...
				float4 appendResult109 = (float4(_Metallic4 , _Metallic5 , _Metallic6 , 0.0));
				...
				float4 appendResult114 = (float4(_Smoothness4 , _Smoothness5 , _Smoothness6 , 0.0));
...
/*ASEBEGIN
Version=17300
420;886;1066;1004;2465.938;2615.401;5.823353;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;121;-1639.968,2957.386;Float;True;Property;_Splat6;Layer 7;8;0;Create;False;0;0;False;0;None;18a1c5cc7397b9847816e03e17440d92;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;122;-1385.29,3034.513;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;123;-1079.423,2892.922;Inherit;True;Property;_TextureSample4;Texture Sample 4;0;0;Create;True;0;0;False;0;-1;None;44b550da39bfea448a4be6b25b1b626c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-1102.047,1524.156;Float;False;Property;_Smoothness3;Smoothness 4;25;0;Create;False;0;0;False;0;0.5;0.442;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-1129.219,-13.69413;Float;False;Property;_Metallic1;Metallic 2;16;0;Create;False;0;0;False;0;0;0.179;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;89;-165.2174,-176.3069;Float;False;return Layer1 * Weight.r + Layer2 * Weight.g + Layer3 * Weight.b + Layer4 * Weight.a + Layer5 * WeightExtra.r + Layer6 * WeightExtra.g + Layer7 * WeightExtra.b@;4;False;9;True;Weight;FLOAT4;0,0,0,0;In;float[5];Half;False;True;WeightExtra;FLOAT4;0,0,0,0;In;;Half;False;True;Layer1;FLOAT4;0,0,0,0;In;;Float;False;True;Layer2;FLOAT4;0,0,0,0;In;;Float;False;True;Layer3;FLOAT4;0,0,0,0;In;;Float;False;True;Layer4;FLOAT4;0,0,0,0;In;;Float;False;True;Layer5;FLOAT4;0,0,0,0;In;;Float;False;True;Layer6;FLOAT4;0,0,0,0;In;;Float;False;True;Layer7;FLOAT4;0,0,0,0;In;;Float;False;Weighted Blend 7;True;False;0;9;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-1096.979,2135.747;Float;False;Property;_Smoothness4;Smoothness 5;26;0;Create;False;0;0;False;0;0;0.442;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1125.719,-719.2783;Float;False;Property;_Metallic0;Metallic 1;15;0;Create;False;0;0;False;0;0;0.391;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;118;-1101.684,2463.427;Inherit;True;Property;_Normal5;Normalmap 6;14;0;Create;False;0;0;False;0;-1;None;3ad3732759f50d64f964c6862190d7cb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;58;-1115.334,699.6114;Float;False;Property;_Metallic2;Metallic 3;17;0;Create;False;0;0;False;0;0;0.154;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;85;-181.3371,-439.5378;Float;False;return Layer1 * Weight.r + Layer2 * Weight.g + Layer3 * Weight.b + Layer4 * Weight.a + Layer5 * WeightExtra.r + Layer6 * WeightExtra.g + Layer7 * WeightExtra.b@;4;False;9;True;Weight;FLOAT4;0,0,0,0;In;float[5];Half;False;True;WeightExtra;FLOAT4;0,0,0,0;In;;Half;False;True;Layer1;FLOAT4;0,0,0,0;In;;Float;False;True;Layer2;FLOAT4;0,0,0,0;In;;Float;False;True;Layer3;FLOAT4;0,0,0,0;In;;Float;False;True;Layer4;FLOAT4;0,0,0,0;In;;Float;False;True;Layer5;FLOAT4;0,0,0,0;In;;Float;False;True;Layer6;FLOAT4;0,0,0,0;In;;Float;False;True;Layer7;FLOAT4;0,0,0,0;In;;Float;False;Weighted Blend 7;True;False;0;9;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;108;-1096.723,2055.536;Float;False;Property;_Metallic4;Metallic 5;21;0;Create;False;0;0;False;0;0;0.09;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-1131.163,-929.2997;Inherit;True;Property;_Normal0;Normalmap 1;9;0;Create;False;0;0;False;0;-1;None;4d6323c1fc1635443912c9a55a30b876;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1113.205,792.0283;Float;False;Property;_Smoothness2;Smoothness 3;24;0;Create;False;0;0;False;0;0.5;0.59;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-1127.09,78.72269;Float;False;Property;_Smoothness1;Smoothness 2;23;0;Create;False;0;0;False;0;0.5;0.366;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;109;-179.6406,1920.273;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.DynamicAppendNode;114;-165.0245,2130.843;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-1123.59,-626.8615;Float;False;Property;_Smoothness0;Smoothness 1;22;0;Create;False;0;0;False;0;0.5;0.449;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;110;47.70078,1876.95;Inherit;False;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;90;-1114.413,1858.02;Inherit;True;Property;_Normal4;Normalmap 5;13;0;Create;False;0;0;False;0;-1;None;3ad3732759f50d64f964c6862190d7cb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;48;-1110.63,1220.124;Inherit;True;Property;_Normal3;Normalmap 4;12;0;Create;False;0;0;False;0;-1;None;f5453dca2ac649e4182c56a3966ad395;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode;112;53.33292,2101.293;Inherit;False;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;120;-1084.25,2741.155;Float;False;Property;_Smoothness5;Smoothness 6;28;0;Create;False;0;0;False;0;0;0.442;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;124;-1062.141,3171.275;Float;False;Property;_Smoothness6;Smoothness 7;27;0;Create;False;0;0;False;0;0.5;0.442;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;44;-1124.177,487.4503;Inherit;True;Property;_Normal2;Normalmap 3;11;0;Create;False;0;0;False;0;-1;None;747ac6003c7d8f24188b85b011b55bc5;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;39;-1130.471,-220.5169;Inherit;True;Property;_Normal1;Normalmap 2;10;0;Create;False;0;0;False;0;-1;None;2bfa6ce6a05caeb4f84f99e403361842;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;125;-1061.885,3091.063;Float;False;Property;_Metallic6;Metallic 7;18;0;Create;False;0;0;False;0;0;0.09;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-1104.176,1431.739;Float;False;Property;_Metallic3;Metallic 4;20;0;Create;False;0;0;False;0;0;0.09;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;130;-160.4764,136.1451;Inherit;True;Constant;_Vector0;Vector 0;29;0;Create;True;0;0;False;0;0.5,0.5,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;119;-1083.994,2660.944;Float;False;Property;_Metallic5;Metallic 6;19;0;Create;False;0;0;False;0;0;0.09;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1637.746,648.4337;Float;False;True;-1;2;ASEMaterialInspector;0;2;MTE/LWRP/7 Textures;1976390536c6c564abb90fe41f6ee334;True;Base;0;0;Base;11;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=-100;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;2;Vertex Position,InvertActionOnDeselection;1;Receive Shadows;1;1;_FinalColorxAlpha;0;4;True;True;True;True;False;;0
...
ASEEND*/
//CHKSM=1FC41B7DB7F64C43C567E3E61F991F62BD721B34