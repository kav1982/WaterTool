...
Shader "Hidden/MTE/PaintTexturePreview/LWRP"
{
    Properties
    {
		...
		_NormalTex ("Normalmap", 2D) = "bump" {}//Splat-texture's normal map
    ...
    SubShader
    {
        ...
        */
        ...
        Pass
        {
            ...
            half3 MTELambertLight (half3 color, half3 normal)
            {
                Light light = GetMainLight();
                half diff = max(0, dot(normal, -light.direction));
                half3 c = color * light.color * diff;
                return c;
            }
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                col.rgb = MTELambertLight(col.rgb, normal);
